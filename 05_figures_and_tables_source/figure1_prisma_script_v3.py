"""
Regenerate Figure 1 PRISMA flowchart - v3 (final pre-submission edits).
...
v3 changes:
  - Removed slash construction: "automated / preliminary screening" →
    "automated filters and preliminary screening".
  - Clarified vague reference: "Overlap of criteria 1 & 2" →
    "Both sample-size and age criteria".
...
# Vertical arrow down from ID box
arrow(33, 100, 33, 76)
...
# "Unexcluded duplicates at preliminary stage" → "Additional duplicates
# identified during detailed screening"
box(62, 60, 35, 18,
...
plt.savefig('Figure1_PRISMA_v3.png', dpi=200, bbox_inches='tight',
            facecolor='white')
plt.close()
print("Saved Figure1_PRISMA_v3.png")
