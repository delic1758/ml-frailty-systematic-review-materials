...
**Execution:** Conducted in response to peer-review feedback, after the primary search.
**Eligibility criteria:** Same prespecified criteria as the primary search.

| # | Database | Provider | Eligible additional records |
|---|---|---|---|
| 5 | IEEE Xplore Digital Library | IEEE | 0 |
| 6 | ACM Digital Library | ACM | 0 |

Most relevant records retrieved from these computer-science databases were conference proceedings, technical workshop papers, or hospital-based feasibility studies that did not meet the prespecified criteria for community-based public health applicability. See `ieee_acm_supplementary_search.md` for the full methodological rationale.
